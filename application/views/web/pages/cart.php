            ...
            <div class="cartpage">
                ...
                <?php if ($this->cart->total_items()) { ?>
                    <table class="tblone">
                        ...
                        foreach ($cart_contents as $cart_items) {
                            ...
                            <tr>
                                ...
                                <td>INR. <?php echo $this->cart->format_number($cart_items['price']) ?></td>
                                <td>
                                ...
                                <td>INR. <?php echo $this->cart->format_number($cart_items['subtotal']) ?></td>
                                <td>
                    ...
                    <table style="float:right;text-align:left;" width="40%">
                        <tr>
                            <th>Sub Total : </th>
                            <td>INR. <?php echo $this->cart->format_number($this->cart->total()) ?></td>
                        </tr>
                        <tr>
                            <th>VAT : </th>
                            <td>INR. 
                        ...
                        <tr>
                            <th>Grand Total :</th>
                            <td>INR. <?php echo $this->cart->format_number($tax + $this->cart->total()); ?> </td>
                        </tr>
                    </table>
                    <?php
                } else {
